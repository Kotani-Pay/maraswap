...
const KotaniTreasury = artifacts.require('KotaniTreasury');
const MockERC20 = artifacts.require('MockERC20');
const UniswapV2Pair = artifacts.require('UniswapV2Pair');
const UniswapV2Factory = artifacts.require('UniswapV2Factory');

contract('KotaniTreasury', ([alice, bar, minter]) => {
    beforeEach(async () => {
        ...
        this.maker = await KotaniTreasury.new(this.factory.address, bar, this.sushi.address, this.weth.address);
    ...
    it('should make SUSHIs successfully', async () => {
        ...
        // After calling convert, bar should have KVT value at ~1/6 of revenue
        ...
        // Should also work for KVT-ETH pair
